...
export const schemaRegisterTech = yup.object().shape({
  title: yup.string().required("Informe o nome da tecnologia"),
...
export const schemaRegisterWork = yup.object().shape({
  title: yup.string().required("Informe o nome do projeto"),
  description: yup.string().required("Campo obrigatório"),
  deploy_url: yup.string().required("Informe o link do projeto"),
});
